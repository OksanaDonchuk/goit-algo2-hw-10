...
def measure_time(sort_function: Callable[[List[int]], List[int]], arr: List[int]) -> float:
    ...
    :param sort_function: Функція сортування
    :param arr: Масив чисел
    :return: Час виконання сортування у секундах
    """
...
def compare_quick_sorts() -> Tuple[List[int], Dict[str, List[float]]]:
    ...
    :return: Кортеж з розмірами масивів та словником із середніми часами виконання
    """
...
def plot_results(sizes: List[int], results: Dict[str, List[float]]) -> None:
    ...
    :param sizes: Розміри масивів
    :param results: Час виконання для кожного сортування
    """
